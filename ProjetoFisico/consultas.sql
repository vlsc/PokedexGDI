-- INNER JOIN projeta o nome e a data de nascimento de todos os médicos
...
-- ANTI JUNCAO projeta a espécie e o id de todos os pokemons que não são tratados por nenhum médico

...
-- SUBCONSULTA TABELA
-- PROJETA O NOME DE TODOS OS TREINADORES CUJA DATA DE NASCIMENTO É MAIOR DO QUE A DATA DE NASCIMENTO DE QUALQUER OUTRO TREINADOR, OU SEJA, TODOS OS TREINADORES MENOS O MAIS VELHO
select nome
from treinador
